...
class Bodegas(models.Model):
    ...
    ciudad = models.CharField(max_length=75, blank=True, null=True)
...
class ProductosBodegas(models.Model):
    id_producto_sucursal = models.AutoField(primary_key=True)
    id_sucursal = models.IntegerField(blank=True, null=True)
    cod_prod = models.CharField(max_length=20, blank=True, null=True)
