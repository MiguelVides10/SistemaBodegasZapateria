...
urlpatterns = [
    ...
    path('cuerporeporteComprasProv/', InventarioReporteComprasProvListView.as_view(), name='repote-talla'),
    path('cuerporeporteComprasNum/', InventarioReporteComprasNumListView.as_view(), name='repote-talla'),
    path('cuerpoReporteVentaDia/', VentaReporteListView.as_view(), name='reporte-ventad'),
    path('cuerpoReporteVentaFecha/', VentaReporteFechasListView.as_view(), name='reporte-venta-fechas'),
